...
import { getSeverityBadge, getComplianceStatus } from "@/components/compliance/compliance-badges";
        ...
        <div className="space-y-4">
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Formulae requiring immediate attention for compliance issues</CardDescription>
                </CardHeader>
                <CardContent>
                    <div className="space-y-4">
