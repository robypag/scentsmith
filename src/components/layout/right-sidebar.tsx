      ...
      <div className="flex-1 p-4 overflow-y-auto bg-sidebar">
        <div className="space-y-4">
          ...
          <div className="flex items-start space-x-3">
            ...
            <div className="bg-sidebar-accent rounded-lg p-3 max-w-[240px]">
              <p className="text-sm text-sidebar-accent-foreground">
                Hello! I&apos;m your AI fragrance assistant. I can help you analyze perfumes, find recommendations, and answer questions about fragrances. How can I assist you today?
              </p>
            </div>
          </div>
          ...
          <div className="text-center text-sidebar-foreground/50 text-sm py-8">
            ...
            <p className="text-xs mt-1">Ask about fragrances, get recommendations, or analyze compositions</p>
          </div>
        </div>
      </div>
