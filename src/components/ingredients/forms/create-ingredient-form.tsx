...
import { createIngredientSchema, CreateIngredientFormData } from "@/lib/validations/ingredient";
...
export function CreateIngredientForm({ onSuccess }: CreateIngredientFormProps) {
    ...
    const onSubmit: SubmitHandler<CreateIngredientFormData> = async (data) => {
